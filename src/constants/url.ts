...
export const LOGIN_URL = `https://github.com/login/oauth/authorize?client_id=2bfae6ca8d1170ab6ddd&state=${BASE_URL}&redirect_uri=${'http://8000-wygin-websitebackend-tqf7xjfehsf.ws-us98.gitpod.io/auth/github/callback'}`;
