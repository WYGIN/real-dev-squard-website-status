...
export const LOGIN_URL = `https://github.com/login/oauth/authorize?client_id=2bfae6ca8d1170ab6ddd&state=${BASE_URL}&redirect_uri=${BASE_URL}/auth/github/callback`;
